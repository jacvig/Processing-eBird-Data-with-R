...
Code for creating a species list for a specific region or hotspot.
...
'Mapping eBird data.R'
Code for creating maps to plot GPS points using Natural Earth (package: rnaturalearth) and Open Street Maps (package: osmdata).
